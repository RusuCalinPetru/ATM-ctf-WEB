            ...
            <div className="card-body">
              <blockquote className="card-blockquote">
                ...
                >
                  <hr />
                  <div style={{ display: "block" }}>
                    <span className="color_white">Ascuns: </span>
                  ...
                  <hr />
                  <div style={{ display: "block" }}>
                    <span className="color_white">Dificultate: </span>
                    <span className="color_white">
                      <select
                        defaultValue={challenge.level.toString()}
                        id={"level" + challenge._id}
                      >
                        <option value="0">Usor</option>
                ...
                >
                  <hr />
                  <div style={{ display: "flex" }}>
                    <label>Bonus prima rezolvare:</label>
                    <p
                      style={{
                        backgroundColor: "rgb(30, 32, 55)",
                        outline: "none",
