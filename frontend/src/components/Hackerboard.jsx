  ...
  const downloadCert = async () => {
    ...
    await axios
      ...
      .then((response) => {
        ...
        if (!team) {
          throw Error("Echipa nu are rezolvari!");
        }
        ...
        anchor.download = "Certificat.png";
        anchor.click();
      })
      .catch((err) => {
          ...
          <div className="row">
            <div className="col-xl-12">
              <h1 className="display-1 bold color_white text-center cool">
                <span className="color_danger"> CLASAMENT </span>HACKERI
              </h1>
              <p className="text-grey lead text-spacey text-center hackerFont">
                Unde cei mai buni din lume sunt clasificati!
              </p>
          ...
          <div className="row mt-5  justify-content-center">
            <div className="col-xl-10">
              ...
              >
                <div>
                  <button
                    ...
                    title={
                      selectionMain === "Users" ? "Vezi Echipe" : "Vezi Utilizatori"
                    }
                  >
                    {selectionMain === "Users" ? (
              ...
              <div style={{ textAlign: "center" }}>
                <h1 className="cool">
                  {selectionMain === "Users" ? "CLASAMENT UTILIZATORI" : "CLASAMENT ECHIPE"}
                </h1>
              </div>
              ...
              <table className="table table-hover table-striped">
                <thead className="thead-dark hackerFont">
                  <tr style={{ textAlign: "center" }}>
                    <th> # </th> <th style={{ textAlign: "left" }}> Nume </th>
                    <th> Rezolvari </th>
                    <th>
                      Scor
                      <button
