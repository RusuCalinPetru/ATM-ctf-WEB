    ...
    axios
      ...
      .then((response) => {
        if (response.data.state === "sessionError") {
          ...
          globalData.alert.success("Indiciu cumparat!");
    ...
    axios
      ...
      .then((response) => {
        if (response.data.state === "sessionError") {
          ...
          globalData.alert.success("Docker-ul provocarii a fost oprit!");
          stoppingDocker = true;
          getChallenges();
        }
      })
    ...
    axios
      ...
      .then((response) => {
        if (response.data.state === "sessionError") {
          ...
          globalData.alert.success("Docker-ul provocarii a fost pornit!");
          getChallenges();
        }
      })
      .catch((err) => {
    ...
    axios
      ...
      .then((response) => {
        if (response.data.state === "success") {
          globalData.alert.success("Flag corect!");
          getChallenges();
          refreshUser();
        } else {
          if (response.data.state === "sessionError") {
        ...
        <div className="container">
          <div className="row">
            <div className="col-xl-12  text-center">
              <h1 className="display-1 bold color_white cool">PROVOCARI</h1>
              <p className="text-grey text-spacey hackerFont lead mb-3">
                E timpul sa arati lumii ce poti face!
              </p>
            </div>
          </div>
          ...
          {counter > 0 ? (
            <div style={{ textAlign: "center" }}>
              <h2 className="cool">CTF-UL NU A INCEPUT INCA!</h2>
              <p>
                {counter < 0 ? (
                  "Reimprospateaza :)"
                ) : (
                          ...
                          <blockquote className="card-blockquote">
                            ...
                            {challenge.hints.map((hint, i) =>
                              hint.cost === 0 ? (
                                ...
                                <a
                                  ...
                                  className="btn btn-outline-danger btn-shadow"
                                  title={"Cumpara Indiciu#" + (i + 1)}
                                >
                                  <span className="fa-solid fa-lightbulb mr-2"></span>
                                  (-{hint.cost.toString()}pct)
                                </a>
                              )
                            )}
                            ...
                            <div className="input-group mt-3">
                              <input
                                ...
                                placeholder="Introdu Flag-ul"
                                aria-label="Introdu Flag-ul"
