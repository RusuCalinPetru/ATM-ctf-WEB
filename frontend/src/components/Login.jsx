    ...
    axios
      ...
      .then((response) => {
        if (response.data.state == "success") {
          //logat, acum get ia data din session
          axios
            ...
            .then((res) => {
              if (res.data.state == "success") {
                globalData.alert.success("Autentificat!");
          ...
          <div className="row">
            <div className="col-xl-8">
              ...
              <p className="text-grey text-spacey hackerFont lead mb-5">
                Introdu credentialele pentru a cuceri lumea
              </p>
                ...
                <div className="col-md-6">
                  ...
                  <div className="form-group">
                    ...
                    <small id="passHelp" className="form-text text-muted">
                      Asigura-te ca nu e nimeni in spatele tau
                    </small>
                  </div>
                </div>
              </div>
